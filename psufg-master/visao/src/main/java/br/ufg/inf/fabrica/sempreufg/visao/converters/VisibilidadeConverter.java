 ...
 * @author Danillo
 */
@FacesConverter("jsfVisibilidadeConverter")
public class VisibilidadeConverter implements Converter{

    @Override
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        return EnumUtils.getEnum(VisibilidadeConverter.class, value);
    }
